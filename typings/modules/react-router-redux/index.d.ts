...
import {History, Location, LocationDescriptor} from '~react-router-redux~history/history';
import {IMiddleware, IStore, IAction, IReducer} from '~react-router-redux~redux/redux';
